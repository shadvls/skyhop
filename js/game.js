...
function handleThemeClick(x,y){var names=["default","sunset","midnight","arctic","swamp"];for(var i=0;i<names.length;i++){var rx=W/2-80+i*32,ry=440;if(x>=rx&&x<=rx+28&&y>=ry&&y<=ry+10){setTheme(names[i])}}}
